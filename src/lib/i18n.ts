...
const resources = {
  ...
  "zh-TW": {
    translation: {
      ...
      "5th": "第五名",
      "2023 ITSA National Software Development Contest": "2023 ITSA 全國大專程式設計極客挑戰賽",
      ...
      "A web application that helps users to arrange their meeting, party schedules.": "幫助使用者輕鬆安排多人會議、派對行程，讓你不再為找不到時間、溝通成本而煩惱！",
      "An AI-powered platform that helps students to learn knowledge more effectively.": "一個 AI 驅動的學習平台，幫助學生更有效率地學習知識以及分析學習狀況。",
      "A web application that helps students to calculate their GPA easily.": "提供 GPA 計分方式以及幫助學生輕鬆計算自己的 GPA，目前僅支援 GPA 4.3 制。",
      "A NFT marketplace that allows users to buy and sell emojis based on Ethereum.": "基於 Ethereum 的 NFT 基礎買賣網站，讓使用者可以買賣自己的 Emoji。",
      "Click to view": "查看",
    },
  },
};
